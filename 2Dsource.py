...
w_e_points = 200                                   ### number of grid cells in the west-east direction
s_n_points = 200	                               ### number of grid cells in the south-north direction
######################################################
...
# Enter the start date of the simulation (1985-10-12, for example)
Date = sys.argv[1] 
